...
#While this paper only uses one test: the log-rank test Mantel–Haenszel test, this test require the raw data. The only data available is means, not daily observations. To work with that data a Wilcoxian test may be able to be used. 
